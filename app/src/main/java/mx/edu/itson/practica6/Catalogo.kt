...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas() {
        ...
        peliculas.add(
            Pelicula(
                titulo = "Héroe Por Encargo",
                R.drawable.heroe_encargo,
                R.drawable.heroexencargo,
                sinopsis = "Un ex agente de las fuerzas especiales acepta un trabajo para brindar seguridad a una periodista mientras entrevista a un dictador, pero estalla un golpe militar en medio de la entrevista y se ven obligados a escapar a la jungla donde deben sobrevivir.\n"
            )
        )
        ...
        peliculas.add(
            Pelicula(
                ...
                R.drawable.vidaspasadas,
                sinopsis = "Nora y Hae Sung, dos amigos de la infancia profundamente unidos, son separados después de que la familia de Nora emigrara de Corea del Sur. Veinte años después, se reúnen durante una fatídica semana para enfrentarse al amor y al destino.\n" +
                        "\n"
            )
        )
    }
    ...
    fun cargarSeries() {
        ...
        series.add(
            Pelicula(
                ...
                R.drawable.ant,
                R.drawable.ant,
                sinopsis = "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego.\n."
            )
        )
        ...
        series.add(
            Pelicula(
                ...
                R.drawable.halo,
                R.drawable.halos,
                sinopsis = "Una evacuación mortal cambia la guerra del Jefe Maestro con el Covenant. En Reach, un nuevo régimen toma el mando en FLEETCOM. John siente una amenaza inminente cerca. Estreno de temporada.\n"
            )
        )
        ...
        series.add(
            Pelicula(
                ...
                R.drawable.sololeveling,
                sinopsis = "En un mundo en el que ciertos humanos llamados “cazadores” poseen habilidades mágicas, estos deben luchar contra monstruos para proteger a la raza humana de una aniquilación segura. Un cazador muy débil llamado Sung Jinwoo se encuentra en una lucha en la que solo puede tratar de sobrevivir.\n"
            )
        )

        series.add(
            Pelicula(
                titulo = "Mi adorable demonio",
                R.drawable.adorable,
                R.drawable.adorabledemonios,
                sinopsis = "Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos.\n"
            )
        )

        series.add(
            Pelicula(
                titulo = "El Monstruo de la Vieja Seúl",
                R.drawable.el_monstruo,
                R.drawable.elmonstruoviej,
        ...
        series.add(
            Pelicula(
                ...
                sinopsis = "Geralt de Rivia, un cazador de monstruos mutante, viaja en pos de su destino por un mundo turbulento en el que, a menudo, los humanos son peores que las bestias."
            )
        )
    }
    ...
    class PeliculaAdapter: BaseAdapter{
        ...
        override fun getView(pe: Int, p1: View?, p2: ViewGroup?): View? {
            ...
            var tittle: TextView = vista.findViewById(R.id.tv_nombre_pelicula)
